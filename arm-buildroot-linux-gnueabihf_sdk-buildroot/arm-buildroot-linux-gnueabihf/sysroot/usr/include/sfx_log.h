...
#if SFX_LOG_DEBUG
#define sfx_log_debug(fmt, args...) \
        __android_log_print(ANDROID_LOG_DEBUG, LOG_TAG, "%s[%s %d] " fmt, AP_CORE, __func__, __LINE__, ##args)
#else
#define sfx_log_debug(fmt, args...) \
    do {                            \
        if (false)                  \
...
#define sfx_log_info(fmt, args...)  \
        __android_log_print(ANDROID_LOG_INFO, LOG_TAG, "%s[%s %d] " fmt, AP_CORE, __func__, __LINE__, ##args)

#define sfx_log_warn(fmt, args...)  \
        __android_log_print(ANDROID_LOG_WARN, LOG_TAG, "%s[%s %d] " fmt, AP_CORE, __func__, __LINE__, ##args)

#define sfx_log_err(fmt, args...)   \
        __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, "%s[%s %d] " fmt, AP_CORE, __func__, __LINE__, ##args)
