...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/perl5/5.28.1/arm-linux',
    archname => 'arm-linux',
    cc => '/home/zyl/code/T113-Tina5.0-V1.2/out/t113/tcam/buildroot/buildroot/host/bin/arm-linux-gnueabihf-gcc',
    d_readlink => 'define',
    d_symlink => 'define',
    dlext => 'so',
    dlsrc => 'dl_dlopen.xs',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/lib/perl5/site_perl/5.28.1/arm-linux',
